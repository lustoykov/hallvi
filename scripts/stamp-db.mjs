...
// A fresh push starts at 0; prepare-db.mjs has already upgraded a v6 file in
// place. Any other version is refused before data could be misread.
const STAMPABLE_VERSIONS = [0, 6, version];
const databasePath =
