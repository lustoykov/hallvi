...
export async function refreshPreparation(applicationId: string) {
  return duringApplicationOperation(
    ...
    {
      command: { type: "refresh-preparation" },
      kind: "inspection",
      title: "Inspect the preparation branch",
    },
  );
}
...
export async function publishPreparationCheckpoint(
  ...
  return duringApplicationOperation(
    ...
    {
      command: { type: "publish-checkpoint", proposalId: proposal.id },
      kind: "change",
      title: "Publish a preparation checkpoint",
    },
  );
}
