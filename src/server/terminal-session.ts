...
const failures: { failure: TerminalFailure; detail: string; test: RegExp }[] = [
  {
    failure: "host-key",
    detail:
      "The server presented a different host key than the one on record. Server Guy will not connect past that; ask in the conversation to review the connection.",
