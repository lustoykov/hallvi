  ...
  const body = (
    <>
      ...
      {facts.length > 0 &&
        ...
        (foldFacts ? (
          <details className="hv-info-more">
      ...
      {record.evidence.length > 0 && (
        <details className="hv-info-evidence">
          <summary>
            What this rests on
    ...
    return (
      ...
      >
        ...
        {superseded ? (
          ...
          <details className="hv-result-more hv-result-alone">
            <summary>
              {passed > 0
                ? `${passed} check${passed === 1 ? "" : "s"} passed · details`
                : "Details"}
            </summary>
            <div className="hv-result-inside">{body}</div>
          </details>
        )}
      </article>
    );
