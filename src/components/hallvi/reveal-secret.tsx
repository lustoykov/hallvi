...
export function RevealSecret({
  ...
  return (
    <div className="hv-reveal">
      ...
      {changing && (
        <p className="hv-reveal-note" data-held="">
      ...
      {error && (
        <p className="hv-reveal-error" role="alert">
          {error}
        </p>
      )}
    </div>
