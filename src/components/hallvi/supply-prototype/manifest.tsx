...
const deciders = [
  ...
  },
  {
    ...
    note: "Held on the host. Hallvi never shows one back, here or anywhere.",
  },
  {
    key: "generated",
    title: "Made by Hallvi",
    ...
    <section className="axma" aria-label="Environment variables">
      ...
      <div className="axma-lede">
        <div>
          ...
          <p>
            ...
            <span>
              No value is printed on this page; a credential Hallvi generated
              opens to a Reveal.{" "}
              {held.length
              ...
              {/* Where the rest live is each value's own source fact, and
                  ...
                  values written by a release, a connection or Hallvi. */}
              {plan.length
      ...
      {story.waiting.length > 0 && (
        <div className="axma-waiting" role="status">
          ...
          <p>
            Hallvi asks for these in the conversation that needs them, and
        ...
        <div>
          ...
          <dd>
            {value.held && applicationId ? (
              <>
                {value.revealable
                  ? `${value.where}. Hallvi generated it, so you have never seen it — read it back here when you need it.`
