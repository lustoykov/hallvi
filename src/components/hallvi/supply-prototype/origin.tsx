...
// the questions Hallvi would answer before recommending one, and the
...
export function OriginDirection({
  ...
  return (
    <section className="axog" aria-label="CDN">
      ...
      <section className="axog-weigh" aria-label="What Hallvi would weigh">
        <h3>{cdn.on ? "What this layer is for" : "What Hallvi would weigh"}</h3>
