      ...
      <dl className="bs-restore-facts">
        ...
        <div>
          ...
          <dd>
            ...
            <small>
              {mode === "isolated"
                ? `${applicationName} keeps serving while Hallvi checks the restored copy.`
                : `${applicationName} stops, and data written after this copy is lost. Hallvi must confirm that with you before it starts.`}
            </small>
          </dd>
        </div>
      </dl>
