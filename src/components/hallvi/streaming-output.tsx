...
export function StreamingOutput({ item }: { item: ExecutionRecord }) {
  ...
  return (
    <>
      {awaiting && (
        <div className="hv-ask">
          <p className="hv-ask-what">
            Hallvi wants to run a command on your server.
          </p>
          <code className="hv-ask-command">
      ...
      >
        ...
        <div className="hv-stream-terminal">
          ...
          <div className="hv-stream-ran">
            <span className="hv-stream-prompt" aria-hidden="true">
              $
            </span>
          ...
          {showCommand && more && (
            <pre className="hv-stream-command" aria-label="Full command">
              <code>{command}</code>
            </pre>
          )}
          <pre
            className="hv-stream-output"
            ref={viewport}
            role="region"
          ...
          >
            {output || (
              <span className="hv-stream-empty">
                {awaiting
          ...
          <div className="hv-stream-controls">
            {Boolean(output) && (
              <button
                type="button"
                aria-pressed={follow}
            ...
            {running && (
              <span className="hv-stream-pulse" role="status">
                {pulse(item, now)}
              </span>
            )}
