...
export function InformationContent({
    ...
    content.kind === "deployment" ? (
      <>
        ...
        {content.changes.length > 0 && (
          <div className="hv-record-changes">
    ...
    return (
      ...
      >
        <div className="hv-result-head">
          <span className="hv-result-dot" data-tone={tone} aria-hidden="true" />
          <h3 title={record.title}>{record.title}</h3>
          <span className="hv-result-then">
            <LocalTime
    ...
    return (
      ...
      >
        ...
        <div className="hv-result-meta">
          ...
          <details className="hv-result-more">
            <summary>Details</summary>
            <div className="hv-result-inside">
              <div className="hv-record-body">
                <InformationBody source={record.body} />
              </div>
              {access && presentation.url && (
                <p className="hv-result-url">
  ...
  return (
    ...
    >
      ...
      {access && (
        <>
          <div className="hv-record-access">
            <span>
              {content.mode === "private" ? (
          ...
          {!compact && content.mode === "private" && (
            <>
              ...
              <p className="hv-record-note">
                This link works on the PC running Hallvi while its SSH tunnel is
      ...
      {compact && details ? (
        <details className="hv-record-details">
      ...
      {record.evidence.length > 0 && (
        <details className="hv-record-evidence">
