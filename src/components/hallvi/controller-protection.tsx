...
/** One sentence for the page's summary: would Hallvi itself survive? */
...
/**
 * Hallvi's own recovery is separate from the application's data. It is
      ...
      <div className="cpb-body">
        {!facts.connected && facts.lastCopyAt ? (
          ...
          <p className="cpb-say">
            ...
            after work in progress finishes. This copies Hallvi, not the
            application.
          </p>
        ) : (
          <p className="cpb-say">
            Hallvi’s conversations, connections, deployment access and decisions
        ...
        {failed && (
          <p className="cpb-failure">
            ...
            {failed.reason} Hallvi tries again within the hour.
          </p>
        )}
        ...
        {unconfirmed && (
          <div className="cpb-kit" aria-label="Recovery kit">
            ...
            <p>
              The copies are encrypted and include every key Hallvi holds,
