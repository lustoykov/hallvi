...
// own scheduled commands, and Server Guy's. For most records the first is
          ...
          <p>
            ...
            <span>
              {story.recurring.length
                ? `One thing does recur on this server, and it is Server Guy’s own: ${story.recurring[0].words.toLowerCase()}.`
        ...
        <section className="axro-col" aria-label="Yours">
          ...
          {mine.length ? (
            ...
            >
              ...
              <p>
                Server Guy would reuse a command the application already has
                rather than adding a second way to trigger it, and runs would
                never overlap: a run that is still going holds the next one
                back, and the skipped occurrence is recorded.
              </p>
            </article>
          )}
        </section>

        <section className="axro-col" aria-label="Server Guy’s">
          <h3>Server Guy’s</h3>
          {story.recurring.length ? (
