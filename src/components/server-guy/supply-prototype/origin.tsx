...
// the questions Server Guy would answer before recommending one, and the
...
export function OriginDirection({
  ...
  return (
    <section className="axog" aria-label="CDN">
      ...
      <section className="axog-weigh" aria-label="What Server Guy would weigh">
        <h3>
          {cdn.on ? "What this layer is for" : "What Server Guy would weigh"}
        </h3>
      ...
      <footer className="axog-foot">
        <p>
          ...
          and Server Guy would state the scope before it cleared anything.
          Setting one up is not implemented yet.
        </p>
        <button
          type="button"
