...
// backlog is only ever shown when an integration reported one; Server Guy
      ...
      <div className="axqu-parts">
        <article className="axqu-part" data-there={broker ? true : undefined}>
          ...
          {broker ? (
            ...
            <p>
              Server Guy would run a private Valkey here, beside the application
              and reachable only from the server, and would say plainly whether
              it keeps queued work across a restart.
            </p>
          )}
        </article>
        <article
