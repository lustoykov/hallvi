    ...
    <section className="axo" aria-label="Overview">
      ...
      <div className="axo-lower">
        ...
        <div className="axo-recent">
          ...
          <button type="button" className="ax-textlink" onClick={() => onOpenDestination("history")}>
            Open History
          ...
          {ideasOpen && (
            <div className="axo-ideas">
              {overview.ideas.map((idea) => (
                <IdeaCard key={idea.id} idea={idea} onAsk={onAsk} onOpenDestination={onOpenDestination} />
              ))}
            </div>
          )}
        </div>
