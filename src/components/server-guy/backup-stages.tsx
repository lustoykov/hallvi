    ...
    return piece.method
      ...
      : protection.declaredAbsent || protection.planned
        ...
        : {
            ...
            detail:
              "Server Guy has not established whether a plan covers this.",
          };
  ...
  if (!pieces.length)
    return (
      <p className="bs-empty-data">
        Server Guy has not established what this application keeps on disk.
      </p>
    );
      ...
      <dl className="bs-restore-facts">
        ...
        <div>
          ...
          <dd>
            ...
            <small>
              {mode === "isolated"
                ? `${applicationName} keeps serving while Server Guy checks the restored copy.`
                : `${applicationName} stops, and data written after this copy is lost. Server Guy must confirm that with you before it starts.`}
            </small>
          </dd>
        </div>
      </dl>
