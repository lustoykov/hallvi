...
// own scheduled commands, and Haldur's. For most records the first is
  ...
  return (
    <section className="axro" aria-label="Jobs">
          ...
          <p>
            ...
            <span>
              {story.recurring.length
                ? `One thing does recur on this server, and it is Haldur’s own: ${story.recurring[0].words.toLowerCase()}.`
      ...
      <div className="axro-cols">
        <section className="axro-col" aria-label="Yours">
          ...
          {mine.length ? (
            ...
            >
              ...
              <p>
                Haldur would reuse a command the application already has rather
        ...
        <section className="axro-col" aria-label="Haldur’s">
          <h3>Haldur’s</h3>
          {story.recurring.length ? (
