...
// Haldur's own commands printed. Calling that "Logs" told an owner
// looking for their application's errors that they were in the right place.
//
// The output Haldur already has, with the time it was captured. Nothing
...
function placeOf(tool: string) {
  return sharedPlaceOf(tool) ?? "Haldur";
}
    ...
    <div className="ax-root sg-section-page sg-section-logs">
      ...
      <header className="sg-section-header">
        <div>
          ...
          <p>
            What Haldur&rsquo;s own commands printed, with when it was captured.
        ...
        {shown.length === 0 && (
          <div className="sg-section-none">
            ...
            <p>
              ...
              Haldur ran has printed anything on record. If you are looking for
