  ...
  const lede = failing
    ...
    : {
        ...
        sub: [
          ...
          story.lastCheckAt
            ? `Haldur last checked it ${when(story.lastCheckAt)}.`
        ...
        ...(watching
          ? {
              label: "Ask Haldur to check it now",
          ...
          : quiet
            ...
            : {
                label: "Ask Haldur to set up a health watch",
          ...
          >
            ...
            <small>
              {on || quiet
                ...
                : "Nothing checks between Haldur's visits, so nothing would tell you if a part stopped."}
            </small>
            {!on && !quiet && (
