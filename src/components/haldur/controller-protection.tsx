...
/** One sentence for the page's summary: would Haldur itself survive? */
...
/**
 * Haldur's own recovery is separate from the application's data. It is
    ...
    >
      ...
      <div className="cpb-body">
        {!facts.connected && facts.lastCopyAt ? (
          ...
          <>
            <p className="cpb-say">
              Losing this Mac would lose Haldur’s conversations, connections,
          ...
          <p className="cpb-say">
            ...
            after work in progress finishes. This copies Haldur, not the
            application.
          </p>
        ) : (
          <p className="cpb-say">
            Haldur’s conversations, connections, deployment access and decisions
            were copied {ago(facts.lastCopyAt, now)} into{" "}
        ...
        {failed && (
          <p className="cpb-failure">
            ...
            {failed.reason} Haldur tries again within the hour.
          </p>
        )}
        ...
        {unconfirmed && (
          <div className="cpb-kit" aria-label="Recovery kit">
            ...
            <p>
              The copies are encrypted and include every key Haldur holds,
