...
- [ ] Run the six `Conformance Result` live-eval cases on explicit opt-in and review their meaning.
- [ ] Take a real private repository through Phase 3 against a real GitHub App grant as a separately authorized integration check; the synthetic GitHub proves the publication logic, not the App's actual permission model.
