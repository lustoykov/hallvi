...
Use disposable deterministic fixtures for the following boundaries. Current run results belong in the [acceptance guide](phase-one-acceptance.md#latest-verification).
