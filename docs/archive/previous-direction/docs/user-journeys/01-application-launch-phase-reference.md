# Historical reference: phase-based Application Launch
...
Status: superseded product/UI design, retained for the phase and evidence definitions used by PR #21. The [current launch journey](../../../../user-journeys/01-application-launch.md) and [accepted architecture](../../../../architecture/agent-directed-operations.md) supersede its mandatory stages, phase-owned chats, environment selector and broad application-code preparation. This file is historical reference, not the direction for new UI work.

[Open the Journey 1 diagrams](../../../../user-journeys/diagrams/01-application-launch.html)
