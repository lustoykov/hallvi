...
- In the Launch Brief, show Approval Mode as an explained three-way choice rather than a dropdown. Capture operational intent as explicit optional launch priorities; never present compressed prose such as “cost-sensitive · database data matters” as an unexplained text field.
