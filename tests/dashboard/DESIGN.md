...
- LLM judgment: verdict chip, reason and model/effort/time, plus a quiet text link, "Judge this answer…" or "Judge again…", for one repetition. The run header's Judge button is the only run-wide control. Judgments never fill or change the human verdict.
