...
- LLM judgment: verdict chip, reason and model/effort/time; no button of its own. Judging lives in one place: the run header (unjudged answers by default). Judgments never fill or change the human verdict.
