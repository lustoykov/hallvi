...
const shots = [
  ...
  ["domains-https", "scenario=simple&step=16&section=domains"],
  ["cdn", "scenario=simple&step=16&section=cdn"],
  ["cdn-none", "scenario=rich&step=19&section=cdn"],
  ["security-open", "scenario=rich&step=13&section=security"],
  ["security-narrowed", "scenario=simple&step=16&section=security"],
