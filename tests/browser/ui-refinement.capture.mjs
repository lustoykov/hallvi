...
const shots = [
  ...
  ["access", "scenario=rich&step=19&section=access"],
  ["access-https", "scenario=simple&step=16&section=access"],
  ["cdn", "scenario=simple&step=16&section=cdn"],
  ["cdn-none", "scenario=rich&step=19&section=cdn"],
  ["access-open", "scenario=rich&step=13&section=access"],
  ["access-simple", "scenario=simple&step=4&section=access"],
