// A real uv.lock for the fixture manifest in repositories.ts, generated once
// with `uv lock` (uv 0.12.5) from exactly that pyproject.toml. The runner's
// `uv sync --locked` verifies the pair; do not edit one without the other.
